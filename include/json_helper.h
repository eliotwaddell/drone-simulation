...
/**
* @brief This class uses static methods to get different attributes of picojson objects
* and returns them as different C++ variables 
**/
class JsonHelper {
...
public:
   ...
   */
  /**
  * @brief Returns the key from json object obj as a json value, throws error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns the key from json object obj as a json object, throws error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns the key from json object obj as a json array, will throw an error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns the key from json object obj as a string, will throw an error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns the key from json object obj as a double, will throw an error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns the key from json object obj as a float vector, will throw an error if key doesn't exist.
  **/
  ...
  /**
  * @brief Returns a boolean value of whether the json object obj contains key or not
  **/
  ...
  /**
  * @brief Returns a new json object.
  **/
  ...
  /**
  * @brief Adds a string value named key to a json object.
  **/
  ...
  /**
  * @brief Adds a float value named key to a json object.
  **/
  ...
  /**
  * @brief Adds a float vector value named key to a json object
  **/
  ...
  /**
  * @brief Creates a json array from a float vector.
  **/
  ...
  /**
  * @brief Encodes the vector of vector floats into an picojson array
  **/
  ...
  /**
  * @brief Helper method for PrintEntityDetails.
  **/
  ...
  **/
  ...
  /**
  * @brief Prints the details of a json object representation of an entity.
  **/
